...
int main() {
	...
	if (loadScene) {
		...
		MaterialInfo::Sptr whitecellMaterial = std::make_shared<MaterialInfo>();
		whitecellMaterial->Shader = scene->BaseShader;
		whitecellMaterial->Texture = ResourceManager::GetTexture(whitecellTex);
