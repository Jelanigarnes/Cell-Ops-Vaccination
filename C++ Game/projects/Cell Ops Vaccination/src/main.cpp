...
int main() {
	...
	if (loadScene) {
		...
		MeshResource::Sptr GameEnemy1Mesh = ResourceManager::CreateAsset<MeshResource>("models/Game enemy.obj");
		MeshResource::Sptr FastEnemyMesh = ResourceManager::CreateAsset<MeshResource>("models/Fast enemy.obj");
		MeshResource::Sptr LargeEnemyMesh = ResourceManager::CreateAsset<MeshResource>("models/enemy_large.obj");
		...
		Texture2D::Sptr LargeEnemyTex = ResourceManager::CreateAsset<Texture2D>("textures/Large_Enemy_Textured.png");
		...
		Material::Sptr WhiteCellMaterial = ResourceManager::CreateAsset<Material>();
		{
			WhiteCellMaterial->Name = "WhiteCell";
			WhiteCellMaterial->MatShader = scene->BaseShader;
			WhiteCellMaterial->Texture = WhiteCellTex;
			WhiteCellMaterial->Shininess = 256.0f;
		}

		Material::Sptr GameEnemyMaterial = ResourceManager::CreateAsset<Material>();
		{
			GameEnemyMaterial->Name = "Enemy";
			GameEnemyMaterial->MatShader = scene->BaseShader;
			GameEnemyMaterial->Texture = GameEnemyTex;
			GameEnemyMaterial->Shininess = 256.0f;
		}
		Material::Sptr FastEnemyMaterial = ResourceManager::CreateAsset<Material>();
		{
			FastEnemyMaterial->Name = "Fast Enemy";
			FastEnemyMaterial->MatShader = scene->BaseShader;
			FastEnemyMaterial->Texture = FastEnemyTex;
			FastEnemyMaterial->Shininess = 256.0f;
		}

		Material::Sptr LargeEnemyMaterial = ResourceManager::CreateAsset<Material>();
		{
			LargeEnemyMaterial->Name = "Large Enemy";
			LargeEnemyMaterial->MatShader = scene->BaseShader;
			LargeEnemyMaterial->Texture = LargeEnemyTex;
			LargeEnemyMaterial->Shininess = 256.0f;
		}
